                        ...
                        <div className="flex-1 overflow-auto">
                            {users.map((user) => (
                                <div key={user.id} onClick={() => setActiveChat(user)} className="px-3 py-4 flex items-center bg-gray-200 cursor-pointer">
                                    <img className="h-12 w-12 rounded-full" src={user.manager_profile_pic?user.manager_profile_pic:"https://cdn-icons-png.flaticon.com/256/3177/3177440.png"} alt="Contact" />
