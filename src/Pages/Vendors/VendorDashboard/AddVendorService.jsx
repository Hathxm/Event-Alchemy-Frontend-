...
const AddVendorService = ({ addvendorservice }) => {
  ...
  return (
    <div>
      <button
        onClick={toggleModal}
        className="flex items-center justify-center flex-1 h-full p-2 bg-blue-400 text-white shadow rounded-lg"
        type="button"
      >
        <span className="text-lg font-bold">+</span> Add Service
      </button>
